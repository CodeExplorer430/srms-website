...
--
-- Host: 127.0.0.1:3308
-- Generation Time: May 23, 2025 at 11:02 PM
...
(3, 'Ana Garcia', 'ana.garcia@example.com', '09456789123', 'School Tour Request', 'Hi! I am interested in enrolling my daughter to your school. Is it possible to schedule a school tour? Thank you very much.', '2025-04-24 21:11:15', 'read', '192.168.1.3');
...
(1, 'HOME', '/index.php', NULL, 1, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(2, 'ADMISSIONS', '/admissions.php', NULL, 2, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(3, 'ABOUT SRMS', '/about.php', NULL, 3, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(4, 'ACADEMICS', '#', NULL, 4, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(5, 'NEWS', '/news.php', NULL, 5, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(6, 'CONTACT', '/contact.php', NULL, 6, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(7, 'ALUMNI', '/alumni.php', 3, 1, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(8, 'FACULTY', '/faculty.php', 3, 2, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(9, 'PRESCHOOL', '#', 4, 1, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(10, 'ELEMENTARY', '#', 4, 2, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(11, 'JUNIOR HIGH', '#', 4, 3, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06'),
(12, 'SENIOR HIGH', '/academics/senior-high.php', 4, 4, 1, '2025-05-18 19:22:06', '2025-05-18 19:22:06');
...
INSERT INTO `navigation_backup` (`id`, `name`, `url`, `parent_id`, `display_order`, `is_active`, `created_at`, `updated_at`) VALUES
...
(13, 'TEST', '#', NULL, 7, 1, '2025-05-18 19:15:14', '2025-05-18 19:15:14');
...
(1, 'hero_image', '/assets/images/campus/hero-background.jpg', '2025-05-20 17:37:16');
...
(1, '/assets/images/campus/hero-main.jpg', 'St. Raphaela Mary School Campus', '', 1, 1),
(2, '/assets/images/promotional/senior-high-free.jpg', 'Free Senior High School Education', 'admissions.php', 2, 1),
(3, '/assets/images/campus/overview.jpg', 'School Activities', '', 3, 1);
...
(7, 'admin1', '$2a$12$CD/0iENYIDhWcCE94OgGh.cvTWXGgoDuemxbwzeC9GhuJsXL6j/OC', 'admin1@srms.edu.ph', 'admin', 1, '2025-05-24 04:52:03', '2025-04-24 22:23:11', '2025-05-23 20:52:03'),
...
ALTER TABLE `navigation`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_nav_order` (`display_order`,`parent_id`),
...
--
-- Indexes for table `offer_box`
--
ALTER TABLE `offer_box`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `page_sections`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `page_id` (`page_id`,`section_key`);
...
--
-- AUTO_INCREMENT for table `offer_box`
--
ALTER TABLE `offer_box`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `page_content`
  ADD CONSTRAINT `page_content_ibfk_1` FOREIGN KEY (`last_updated_by`) REFERENCES `users` (`id`);

--
-- Constraints for table `page_sections`
--
ALTER TABLE `page_sections`
  ADD CONSTRAINT `page_sections_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `page_content` (`id`);
